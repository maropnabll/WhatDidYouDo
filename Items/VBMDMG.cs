...
{
	public class VBMDMG : ModItem
	{
		public override void SetStaticDefaults() {
			DisplayName.SetDefault("V.B.M.D.M.G");
			Tooltip.SetDefault("78% chance to not consume ammo /nWhat did you do?!");
		}

		public override void SetDefaults() {
			item.damage = 270; // Sets the item's damage. Note that projectiles shot by this weapon will use its and the used ammunition's damage added together.
			...
			item.value = 24000; // how much the item sells for (measured in copper)
		...
		public override void AddRecipes() {
			...
			recipe.AddIngredient(ItemID.VortexBeater, 10);
		...
		{
			return Main.rand.NextFloat() >= .78f;
		}
